#ifndef FSHADING_LIGHTING_INCLUDED
#define FSHADING_LIGHTING_INCLUDED
...
#ifdef _SUBSURFACE
    half NdotLWrap = saturate((dot(normalWS, lightDirectionWS) + subsurfaceColor.r) / ((1 + subsurfaceColor.r) * (1 + subsurfaceColor.r)));

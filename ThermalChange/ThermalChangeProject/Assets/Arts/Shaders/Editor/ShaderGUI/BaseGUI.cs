...
namespace Feng.Shading.Editor
{
    ...
    {
#region Structs 结构体(命名+对应Shader名称)
        struct Styles
        {
            // 折叠栏
...
#region Enumerations 枚举栏
        ...
        /// <summary>
        /// Workflow mode (specular0/metallic1) enumeration for shaders.
        /// </summary>
...
#region Fields 字段声明
        const string fEditorPrefKey = "fShading:BaseGUI:";
        const int fQueueOffsetRange = 50;
...
#region Properties 绘制
        /// <summary>
        /// 在 OnGUI 调用期间获取 MaterialProperty 字段
        /// </summary>
        /// <param name="properties">要访问的 MaterialProperty 数组</param>  
        public abstract void GetProperties(MaterialProperty[] properties);

        /// <summary>
        /// 在“Surface Inputs”折页中绘制 MaterialProperty 字段
        /// </summary>
        /// <param name="materialEditor">MaterialEditor 当前正在绘制</param>  
        ...
        void DrawAdvancedOptions(MaterialEditor materialEditor)
        {
            ...
            {
                EditorGUI.BeginChangeCheck();
                var queueOffset = EditorGUILayout.IntSlider(Styles.Priority, (int)m_QueueOffsetProp.floatValue, -fQueueOffsetRange, fQueueOffsetRange);
                if (EditorGUI.EndChangeCheck())
                {
...
#region Keywords
        ...
        void SetBaseMaterialKeywords(Material material)
        {
            ...
            {
                queueOffset = fQueueOffsetRange - (int) material.GetFloat("_QueueOffset");
            }
...
#region EditorPrefs
        bool GetFoldoutState(string name)
        {
            ...
            return EditorPrefs.GetBool($"{fEditorPrefKey}.{name}");
        }
        ...
        void SetFoldoutState(string name, bool field, bool value)
        {
            ...
            EditorPrefs.SetBool($"{fEditorPrefKey}.{name}", value);
            field = value;
        }
#endregion
    }

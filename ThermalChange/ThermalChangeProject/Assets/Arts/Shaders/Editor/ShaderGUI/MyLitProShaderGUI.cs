...
namespace Feng.Shading.Editor
{
    sealed class LitProGUI : BaseGUI
    {
#region Structs
        struct Labels
        {
            ...
            public static readonly GUIContent EnableHeight = new GUIContent("Height",
                "Enable Parallax and ParallaxScale for the surface");
            
            public static readonly GUIContent Height = new GUIContent("Height", 
                "Assigns a tangent-space parallax map.");
        ...
        struct PropertyNames
        {
            ...
            public static readonly string EnableParallax = "_EnableParallax";
            public static readonly string ParallaxMap = "_ParallaxMap";
            public static readonly string ParallaxScale = "_ParallaxScale";
...
#region Fields
        ...
        MaterialProperty m_EnableParallaxProp;
        MaterialProperty m_ParallaxMapProp;
        MaterialProperty m_ParallaxScaleProp;
...
#region GUI
        public override void GetProperties(MaterialProperty[] properties)
        {
            ...
            m_EnableParallaxProp = FindProperty(PropertyNames.EnableParallax, properties, false);
            m_ParallaxMapProp = FindProperty(PropertyNames.ParallaxMap, properties, false);
            m_ParallaxScaleProp = FindProperty(PropertyNames.ParallaxScale, properties, false);
        ...
        public override void DrawSurfaceInputs(MaterialEditor materialEditor)
        {
            ...
            // Normal
            materialEditor.TexturePropertySingleLine(Labels.Normal, m_BumpMapProp, 
                m_BumpMapProp.textureValue != null ? m_BumpScaleProp : null);
            ...
            // Height
            materialEditor.ShaderProperty(m_EnableParallaxProp, Labels.EnableHeight);
            if (m_EnableParallaxProp.floatValue == 1.0)
            {
                //materialEditor.TexturePropertySingleLine(Labels.Height, m_ParallaxMapProp, m_ParallaxScaleProp);
                materialEditor.TexturePropertySingleLine(Labels.Height, m_ParallaxMapProp, 
                 m_ParallaxMapProp.textureValue != null ? m_ParallaxScaleProp : null);
            }
...
#region Keywords
        public override void SetMaterialKeywords(Material material)
        {
            ...
            // Height
            material.SetKeyword("_PARALLAX", material.GetFloat(PropertyNames.EnableParallax) == 1.0f);
            material.SetKeyword("_PARALLAXMAP", material.GetTexture(PropertyNames.ParallaxMap) != null);
